...
class Settings(BaseSettings):
    ...
    nocodb_table_users: str = Field(alias="NOCODB_TABLE_USERS")
    nocodb_table_projects: str = Field(alias="NOCODB_TABLE_PROJECTS")
    nocodb_table_inbox: str = Field(alias="NOCODB_TABLE_INBOX")
    nocodb_table_tasks: str = Field(alias="NOCODB_TABLE_TASKS")
    nocodb_table_actions: str = Field(alias="NOCODB_TABLE_ACTIONS")
